...
When you are looking at the `quotable` Github, click on the `Issues` tab. This is where users/developers can say "there is a problem with this code/software..."
...
To fix your app, find another API which can get a random quote. You will need to alter your code so that your app uses the new API... **DO THIS WITHOUT USING AI**...
...
**HINT 1**:
You can call an API from your terminal to check what your app will "see" when it calls the API. If you are using a `bash` terminal, you can use:
`curl`:
...
**HINT 2**:
There is a clue somewhere in this Github repository which tells you which API you can use to fix your app...

You can also ask me for an extra hint...
