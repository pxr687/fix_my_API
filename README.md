...
To fix your app, you may want to look for another API which can get a random quote. 
You will need to alter your code so that your app uses the new API... **DO THIS WITHOUT USING AI**...
